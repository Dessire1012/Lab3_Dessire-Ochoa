        ...
        while (opcion != 10) {
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    for (int i = 0; i <= 6; i++) {
                        ...
                        if (opcion == 1) {
                            ...
                            listEntrenadores.add(new Novato(nombreE, edad, sexo));
                        }
                ...
                case 9:
                    ...
                    if (opcion2 == 4) {
                        ((Legendario) gyms.get(opcion).getListaEntrenadores().get(posicion2)).setPokemonLeg(pokemones.get(posicion));
                        pokemones.remove(opcion2);
